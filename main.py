...
class Menu:
    def First_admin(self):
        ...
        if answer == 1:
            ...
            answer = "Посмотреть все обращения"
        elif answer == 4:
            answer = "Оставить обращение"
        elif answer == 5:
            answer = "Выход"
    ...
    def Admin(self):
        answer = get_choice(["Посмотреть все обращения", "Оставить обращение", "Выход"])
        if answer == 1:
            answer = "Посмотреть все обращения"
        elif answer == 2:
            answer = "Оставить обращение"
    ...
    def User(self):
        answer = get_choice(["Оставить обращение", "Выход"])
        if answer == 1:
            answer = "Оставить обращение"
        elif answer == 2:
            answer = "Выход"
        ...
        if ans == 1:
            ...
            while b:
                ...
                if Role == "First-admin":
                    ...
                    elif choice == "Посмотреть все обращения":
                        menu.check_appeals()
                        clear_screen()

                    #! Оставить обращение
                    elif choice == "Оставить обращение":
                    ...
                    choice = menu.Admin()
                    #! Посмотреть все обращения
                    if choice == "Посмотреть все обращения":
                        menu.check_appeals()
                        clear_screen()
